...
import static com.haulmont.addon.dashboard.web.DashboardIcon.GRID_LAYOUT_ICON;
import static com.haulmont.addon.dashboard.web.DashboardIcon.HORIZONTAL_LAYOUT_ICON;
import static com.haulmont.addon.dashboard.web.DashboardIcon.VERTICAL_LAYOUT_ICON;
import static com.haulmont.addon.dashboard.web.DashboardStyleConstants.AMXD_DASHBOARD_BUTTON;
...
public class PaletteComponentsFactoryImpl implements PaletteComponentsFactory {
    ...
    protected PaletteButton createCommonButton(){
        ...
        button.setStyleName(DashboardStyleConstants.AMXD_DASHBOARD_BUTTON);
        return button;
    }
}
