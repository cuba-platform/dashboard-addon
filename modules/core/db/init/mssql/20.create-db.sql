...
create unique index IDX_DASHBOARD_WIDGET_TEMPLATE_GROUP_UNIQ_NAME on DASHBOARD_WIDGET_TEMPLATE_GROUP (NAME, DELETE_TS) ^
-- end DASHBOARD_WIDGET_TEMPLATE_GROUP
-- begin DASHBOARD_DASHBOARD_GROUP
create unique index IDX_DASHBOARD_DASHBOARD_GROUP_UNIQ_NAME on DASHBOARD_DASHBOARD_GROUP (NAME, DELETE_TS) ^
...
create unique index IDX_DASHBOARD_PERSISTENT_DASHBOARD_UNIQ_REFERENCE_NAME on DASHBOARD_PERSISTENT_DASHBOARD (REFERENCE_NAME, DELETE_TS) ^
